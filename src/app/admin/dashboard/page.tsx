  ...
  const handleExportExcel = () => {
    ...
    try {
      ...
      const summaryData = [
        ...
        ['รายการอุปกรณ์ที่ใกล้หมด (≤ 2) ทั้งหมด', stats.lowStockItems || 0],
        [''],
        ...
        ['หัวข้อ', 'จำนวน'],
        ['จำนวนทั้งหมด', selectedMonth === 'all' ? (stats.totalInventoryCount || stats.totalInventoryItems || 0) : (stats.totalInventoryItemsInPeriod || 0)],
        ['รายการอุปกรณ์ที่ใกล้หมด (≤ 2)', selectedMonth === 'all' ? stats.lowStockItems : (stats.lowStockItemsInPeriod || 0)],
        [''],
